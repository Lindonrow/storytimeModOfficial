...
{
	public class RandyllThorJrStatue : ModTile
	{
		...
		{
			Item.NewItem(new EntitySource_TileBreak(x, y), x * 16, y * 16, 48, 32, ModContent.ItemType<Items.Placeable.Furniture.RandyllThorJrStatueItem>());
		}
	}
}
